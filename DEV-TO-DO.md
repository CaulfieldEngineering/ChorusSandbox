...
3. Break out templatized plug-in web page to its own repository so all plug-ins reference the same source code each time.  Leave product-specific information within the plug-in's folder.